...
# NEW: add a parameter to directly specify the dataset folder (for example, for Stanford Cars)

parser.add_argument('--dataset_path', default=None, type=str, help='Direct path to the specific dataset folder if it is not in the default location')
